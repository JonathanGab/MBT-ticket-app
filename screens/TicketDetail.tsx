    ...
    return (
        <View style={stylesTicketDetail.container}>
            ...
            <View style={stylesTicketDetail.bodyContainer}>
                ...
                <View style={stylesTicketDetail.priority}><Text style={stylesTicketDetail.priorityText}>Priority : {priorityValue}</Text></View>
                <View style={stylesTicketDetail.difficulty}><Text style={stylesTicketDetail.priorityText}>Difficulty : {difficultyValue}</Text></View>
                <View style={stylesTicketDetail.status}><Text style={stylesTicketDetail.priorityText}>Status : {statusValue}</Text></View>
            </View>
        </View>
    )
}